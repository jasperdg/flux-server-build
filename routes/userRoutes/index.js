...
var _getOpenEthInOrders = _interopRequireDefault(require("../../private/users/getOpenEthInOrders"));

var _getOpenSharesInOrders = _interopRequireDefault(require("../../private/users/getOpenSharesInOrders"));
...
router.get('/add', _middleware.default,
/*#__PURE__*/
function () {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0, _getOpenEthInOrders.default)(req);
...
router.post('/open_shares_orders',
/*#__PURE__*/
function () {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return (0, _getOpenSharesInOrders.default)(req);
